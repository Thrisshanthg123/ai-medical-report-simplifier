...
export default function HistoryLoading() {
  return (
    ...
    >
      ...
      <div className="relative pl-6 sm:pl-8 space-y-8 before:absolute before:left-2 sm:before:left-3 before:top-2 before:bottom-2 before:w-0.5 before:bg-border">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="relative space-y-3">
            {/* Timeline Node Icon Skeleton */}
            <div className="absolute -left-6 sm:-left-8 top-4 w-5 h-5 rounded-full border-2 border-border bg-surface flex items-center justify-center">
